...
public class Login extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loginEmailId = findViewById(R.id.emaillogin);
        logInpasswd = findViewById(R.id.passwordlogin);
                    ...
                    firebaseAuth.signInWithEmailAndPassword(userEmail, userPaswd).addOnCompleteListener(Login.this, new OnCompleteListener() {
                        ...
                        public void onComplete(@NonNull Task task) {
                            if (!task.isSuccessful()) {
                                ...
                                startActivity(new Intent(Login.this,StagerActivity.class));
...
//        firebaseAuth.addAuthStateListener(authStateListener);
        ...
        if (user != null) {
            ...
            Intent I = new Intent(Login.this, StagerActivity.class);
            startActivity(I);
            finish();
        } else {
